...
class AgentController:
    ...
    async def _handle_message_action(self, action: MessageAction) -> None:
        ...
        if action.source == EventSource.USER:
            ...
            # Exception: empty-content messages are often generated by models (e.g. Gemini Flash)
            # as a no-op between tool calls. Don't pause execution for those.
            if action.wait_for_response and action.content.strip():
                await self.set_agent_state_to(AgentState.AWAITING_USER_INPUT)
