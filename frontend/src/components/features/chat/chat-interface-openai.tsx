...
import { UserMessage, AssistantMessage, TypingIndicator } from "./chat-message-bubble";
        ...
        {messages.length === 0 && !isLoading && (
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            <div className="w-16 h-16 mb-6 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-gray-600 dark:text-gray-400">
            ...
            <p className="text-gray-500 dark:text-gray-400 max-w-md">
              I can help you write code, debug issues, answer questions, and more.
            </p>
          </div>
        )}
